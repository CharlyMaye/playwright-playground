 ...
 * selects, textareas, ARIA roles) and reference web-specific facts
 * (`tag`, `inputType`, `ariaExpanded`) — hence they belong to the web
 * adapter, registered through the {@link DefaultRules} port.
 *
...
/** {@link DefaultRules} implementation registered by the Playwright adapter. */
export class HtmlDefaultRules extends DefaultRules {
  get rules(): RuleProperties[] {
    return DEFAULT_HTML_RULES;
  }
}
